        ...
        Align(
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              ...
              child: ValueListenableBuilder<TowerType>(
                valueListenable: game.selectedTowerNotifier,
                builder: (context, selectedTower, child) {
                  return Row(
                    ...
                    children: [
                      ...
                      _buildTowerButton(game, TowerType.NINJA, 'Ninja', 200,
                          'defender_ninja.png'),
                      const SizedBox(width: 8),
                      _buildTowerButton(game, TowerType.BERSERKER, 'Berserk',
                          150, 'defender_berserker.png'),
                      const SizedBox(width: 8),
                      _buildTowerButton(game, TowerType.MISSILE, 'Missile', 500,
                          'defender_missile.png'),
                      const SizedBox(width: 8),
                      _buildTowerButton(game, TowerType.FACTORY, 'Merchant',
                          400, 'tower_factory.png'),
                      const SizedBox(width: 8),
                    ],
                  );
                },
